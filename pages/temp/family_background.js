             ...
             <div class="mt-6 mb-8 mx-12 p-14 font-sans">
                    <form> 
                        ...
                        <div class="flex justify-center space-x-4 mb-5 mt-6 text-yellow-500 font-bold">
                            <Link href="/personal"><button class="rounded-full bg-indigo-900 px-10 py-2">NEXT</button></Link>
                            <Link href="/educational_attainment"><button class="rounded-full bg-indigo-900 px-10 py-2">NEXT</button></Link>
                        </div>
...
FamilyBackground.getLayout = function getLayout(page) {
    return (
        <NavBarLayout>
            {page}
        </NavBarLayout>
