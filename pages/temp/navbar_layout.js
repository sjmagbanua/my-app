...
export default function NavBarLayout({ children, currentTab }) {
    ...
    return (
        <div className="h-full w-full flex-col">
            {/* navbarhead */}
            <nav className="sticky top-0 bg-indigo-900 flex w-full md:bg-indigo-900 p-3">
                <div className="">
                    <Link href="/personal"><a><img className="h-16" src="image/logo1.png" /></a></Link>
                </div>
            </nav>

                {/* menubar */}
                <div className="flex flex-col bg-indigo-900 md:hidden">
            ...
            <div className="flex w-full flex-col md:flex-row">
                ...
                {
                    shownav && (
                        <div className="flex-none w-50 shadow-md bg-indigo-900 font-bold sm:hidden">
                        <ul className="">
                            <li className="">
                ...
                <div className="flex-1 ">
                    ...
                    <div className="items-center flex justify-center ">
                        ...
                        <div className="border-solid border-2 border-indigo-500 leading-4 h-px w-40"></div>
                        <div>
            ...
            <div className="bg-indigo-900 flex w-full justify-center p-3 text-yellow-500">
